...
public class Aula3 {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "Aprendendo Algoritmos", "Algoritmo 11", JOptionPane.INFORMATION_MESSAGE);

        JOptionPane.showMessageDialog(null, "Aprendendo Algoritmos!!!" + "Com Anitta e Guto", "Algoritmo 12",
                JOptionPane.INFORMATION_MESSAGE);

        int x1 = 10;

        JOptionPane.showMessageDialog(null, x1, "Algoritmo 16", JOptionPane.INFORMATION_MESSAGE);

        JOptionPane.showMessageDialog(null, x1 + 1, "Algoritmo 18", JOptionPane.INFORMATION_MESSAGE);
        ...
        JOptionPane.showMessageDialog(null, dezena, "Algoritmo 23", JOptionPane.INFORMATION_MESSAGE);

        String converter1 = JOptionPane.showInputDialog("Digite a data no formato DD/MM/AA sem espacos e caracteres!");
        ...
        String converter2 = JOptionPane.showInputDialog("Digite a data no formato DD/MM/AA sem espacos e caracteres!");
        ...
        JOptionPane.showMessageDialog(null, "A media aritmetica dos numeros 8, 9 e 7 eh: " + "\n\n" + media,
        ...
        JOptionPane.showMessageDialog(null,
                "O valor do divisor eh: " + divisor + "\n" + "O valor do dividendo eh: " + dividendo + "\n"
        ...
        JOptionPane.showMessageDialog(null, "O valor da media ponderada eh: " + mp, "Algoritmo 41",
                JOptionPane.INFORMATION_MESSAGE);

        Double ang, rang;

        String converter5 = JOptionPane.showInputDialog(null, "Digite o valor do Angulo", "Algoritmo 42",
                JOptionPane.INFORMATION_MESSAGE);
        ...
        JOptionPane.showMessageDialog(null, "O Logaritmo eh:" + log,"Algoritmo 43", JOptionPane.INFORMATION_MESSAGE);
